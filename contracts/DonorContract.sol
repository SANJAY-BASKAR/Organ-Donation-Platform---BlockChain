...
contract DonorContract {
    ...
    function updateDonorPhone(string memory _medical_id, string memory _phone)
    public
    {
        require(keccak256(abi.encodePacked((donorMap[_medical_id].medical_id))) == keccak256(abi.encodePacked(_medical_id)));
        donorMap[_medical_id].phone = _phone;
    }
    ...
    function getDonorPhone(string memory _medical_id) view public returns(string memory)
    {
        return donorMap[_medical_id].phone;
    }
